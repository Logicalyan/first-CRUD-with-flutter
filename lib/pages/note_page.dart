...
import 'package:crud_dua/services/service_supabase.dart';
import 'package:crud_dua/models/note.dart';
                ...
                return ListTile(
                  ...
                  trailing: SizedBox(
                    ...
                    child: Row(
                      children: [
                        IconButton(
                            onPressed: () => updateNote(note), icon: const Icon(Icons.edit)),
                        IconButton(
                            onPressed: () => deleteNote(note), icon: const Icon(Icons.delete)),
                      ],
                    ),
                  ),
                );
